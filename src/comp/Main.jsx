    ...
    return releaseDate < Date.now() ?
        ...
        <div className="mainContainer ">
            ...
            <div className="description ">
                ...
                Тут <s>можно</s> нужно придумать набор из своих категорий. Там какие то цифарки тикают ну да похуй.
                </div>
            ...
            <div className="description ">
                ...
                Если нужны заготовки другого размера тоже пишите.
                </div>

            <h1>Основная Хуйня</h1>
            <div className="commentary ">Какие то цифарки?</div>
